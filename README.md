# <Horiseon-Marketing-Refactor-Challenge>
...
The webpage should load with no errors and the all the links should be working correctly.  If you open the developer console (right click on the page) the structure of the html and css should structured in a logical way with semantic elements.
